...
<body style = "background-color:#EEE8AA">
    <div class="container">
        <h1>Orders | <a href='newactor.php'><span class='glyphicon glyphicon-plus-sign' style = "color:#8A2BE2"></span></a>
        |<a href='staff.php?id=$row->id'><span class='glyphicon glyphicon-user' style = "color:#00FA9A7"></span></a>
        ...
        <form action="#" method="post">
            <input type="text" name="kw" placeholder="Enter Order, Order name" value=""  style = "background-color:#0000FF">
            <input type="submit" style = "background-color:#FF4500">
        </form>
        <?php

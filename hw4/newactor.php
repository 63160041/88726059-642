    ...
    <div class="container">
        ...
        <form action="newactor.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="doc_num" id="doc_num" style = "background-color:#FFFF00">
            </div>
            <div class="form-group">
                <label for="doc_title">Order Name</label>
                <input type="text" class="form-control" name="doc_title" id="doc_title" style = "background-color:#FFFF00">
            </div>
            <div class="form-group">
                <label for="doc_start_date">Start Date</label>
                <input type="date" class="form-control" name="doc_start_date" id="doc_start_date" style = "background-color:#FFFF00">
            </div>
            <div class="form-group">
                <label for="doc_to_date">To Date</label>
                <input type="date" class="form-control" name="doc_to_date" id="doc_to_date" style = "background-color:#FFFF00">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control" name="doc_file_name" id="doc_file_name"  style = "background-color:#FF69B4">
            </div>
            <br>
            
            <button type="button" class="btn btn-warning" onclick="history.back();" style = "background-color:#FF0033">Back</button>
            <button type="submit" class="btn btn-success" style = "background-color:#00FF66">Save</button>
        </form>
</body>
